...
via emit_picks. The seed is used VERBATIM in every RNG stream -- clients
that need a per-round derivation (e.g. `42 ^ round_idx`) apply it on
their side before calling.
"""
...
from .gp import bounds_tensor, fit, to_f64
